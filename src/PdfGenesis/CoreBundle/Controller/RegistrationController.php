...
/**
 * Override of the registration controller
 *
 * @author Justine Benezra
 */
    ...
    public function registerAction(Request $request)
    {
        ...
        if ($form->handleRequest($request)->isSubmitted()) {
            ...
            if ($form->isValid()) {
                ...
                $this->get('session')->getFlashBag()->add('registration_confirmed', 'confirmed');
            ...
            $this->get('session')->getFlashBag()->add('registration_error', 'error');
